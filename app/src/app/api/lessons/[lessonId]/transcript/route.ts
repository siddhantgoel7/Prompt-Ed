// API route for transcribing instructor audio using gpt-4o-transcribe.
 ...
 * Transcribes an audio recording via gpt-4o-transcribe and stores the result as a lesson chunk.
