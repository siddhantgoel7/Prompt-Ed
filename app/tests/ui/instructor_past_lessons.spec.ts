...
test.describe('Instructor Past Lessons', () => {
    ...
    test('[US 1.14] success: view past lesson records details', async ({ page }) => {
        ...
        // We look specifically for the Card component surrounding our prompt text
        ...
        // We use getByRole to specifically target the h2 section title
        await expect(page.getByRole('heading', { name: 'Discussions', exact: true })).toBeVisible();

        // 4. Find the button INSIDE that specific card
        // Matches the "Show Responses (2)" text generated by your new component
        ...
        // These are rendered within the bg-gray-50 rounded-md containers in your EndedDiscussionCard
